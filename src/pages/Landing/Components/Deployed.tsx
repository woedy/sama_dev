...
const DeploySection = () => {
  ...
  const projects = [
    {
      ...
      androidLink:
        'https://play.google.com/store/apps/details?id=com.send_libra.app.send_libra', // ✅ Replace with actual URL
    ...
    },
    {
      ...
      androidLink:
        'https://play.google.com/store/apps/details?id=com.tuaneka.teamalfy', // ✅ Replace with actual URL
      iosLink: '#', // ✅ Replace with actual URL
      image: '🧾',
    },
  ];
  ...
  return (
    <section id="deployed apps" className="py-20 px-6">
